...
require 'which-key'.register {
  ...
  ['<leader>fC'] = { function() M.format_input() end, 'nvim.lsp: format_input', mode = { 'n', 'v', }, },
  ...
  ['<leader>f<c-w>'] = { function() M.stop_all() end, 'nvim.lsp: stop_all', mode = { 'n', 'v', }, },
  ...
  ['<leader>fve'] = { function() M.retab_erase_bad_white_space() end, 'nvim.lsp: retab_erase_bad_white_space', mode = { 'n', 'v', }, },
  ['<leader>fvd'] = { function() M.type_definition() end, 'nvim.lsp: type_definition', mode = { 'n', 'v', }, },
  ['[d'] = { function() M.diagnostic_goto_prev() end, 'nvim.lsp: diagnostic_goto_prev', mode = { 'n', 'v', }, },
  ['[f'] = { function() M.diagnostic_open_float() end, 'nvim.lsp: diagnostic_open_float', mode = { 'n', 'v', }, },
  [']d'] = { function() M.diagnostic_goto_next() end, 'nvim.lsp: iagnostic_goto_next', mode = { 'n', 'v', }, },
  [']f'] = { function() M.diagnostic_setloclist() end, 'nvim.lsp: diagnostic_setloclist', mode = { 'n', 'v', }, },
  ['<leader>fo'] = { function() M.declaration() end, 'nvim.lsp: declaration', mode = { 'n', 'v', }, },
  ['<leader>fw'] = { function() M.ClangdSwitchSourceHeader() end, 'nvim.lsp: ClangdSwitchSourceHeader', mode = { 'n', 'v', }, },
  ['<leader>fd'] = { function() M.definition() end, 'nvim.lsp: definition', mode = { 'n', 'v', }, },
  ['<leader>fe'] = { function() M.references() end, 'nvim.lsp: references', mode = { 'n', 'v', }, },
  ['<leader>fh'] = { function() M.hover() end, 'nvim.lsp: hover', mode = { 'n', 'v', }, },
}
